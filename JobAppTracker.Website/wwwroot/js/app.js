...
var appRoot_1 = __webpack_require__(33);
var createHistory = __webpack_require__(6).createBrowserHistory;
ko.components.register('app-root', appRoot_1.default);
...
var navMenu_1 = __webpack_require__(35);
var footer_1 = __webpack_require__(37);
var AppRootViewModel = (function () {
    function AppRootViewModel(params) {
        ...
        this._router = new router_1.Router(params.history, this.routes);
        this.route = this._router.currentRoute;
        ko.components.register('nav-menu', navMenu_1.default);
        ko.components.register('app-footer', footer_1.default);
        ko.components.register('jobapps', __webpack_require__(39));
        ko.components.register('contacts', __webpack_require__(40));
    }
    return AppRootViewModel;
}());
exports.default = { viewModel: AppRootViewModel, template: __webpack_require__(41) };
...
var ko = __webpack_require__(0);
var $ = __webpack_require__(2);
var crossroads = __webpack_require__(10);
var Router = (function () {
    function Router(history, routes) {
        ...
        $(document).on('click', '#appNav a', function (evt) {
...
var NavMenuViewModel = (function () {
    ...
    NavMenuViewModel.prototype.CollapseMenu = function () {
        $('#navbar').collapse('hide');
    };
    return NavMenuViewModel;
}());
exports.default = { viewModel: NavMenuViewModel, template: __webpack_require__(36) };
...
module.exports = "<nav class=\"navbar navbar-inverse navbar-fixed-top\">\r\n\t<div class=\"container\">\r\n\t\t<div class=\"navbar-header\">\r\n\t\t\t<button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#navbar\" aria-expanded=\"false\" aria-controls=\"navbar\">\r\n\t\t\t\t<span class=\"sr-only\">Toggle navigation</span>\r\n\t\t\t\t<span class=\"icon-bar\"></span>\r\n\t\t\t\t<span class=\"icon-bar\"></span>\r\n\t\t\t\t<span class=\"icon-bar\"></span>\r\n\t\t\t</button>\r\n\t\t\t<a class=\"navbar-brand\" href=\"/\">Job App Tracker</a>\r\n\t\t</div>\r\n\r\n\t\t<div id=\"navbar\" class=\"navbar-collapse collapse\">\r\n\t\t\t<ul id=\"appNav\" class=\"nav navbar-nav\" data-bind=\"foreach: routes\">\r\n\t\t\t\t<li data-bind=\"css: { 'active': $parent.route().page === params.page }\"><a data-bind=\"text: params.name, attr: { href: url }, click: $parent.CollapseMenu\"></a></li>\r\n\t\t\t</ul>\r\n\r\n\t\t\t<ul class=\"nav navbar-nav navbar-right\">\r\n\t\t\t\t<li><a href=\"/Account/Logout\">Logout</a></li>\r\n\t\t\t</ul>\r\n\t\t</div>\r\n\t</div>\r\n</nav>"
...
exports.default = { viewModel: FooterViewModel, template: __webpack_require__(38) };
...
module.exports = "<nav-menu params=\"route: route, routes: routes\"></nav-menu>\r\n\r\n<main class=\"container\">\r\n\t<div data-bind='component: { name: route().page, params: route }'></div>\r\n\t<br />\r\n\t<br />\r\n</main>\r\n\r\n<app-footer></app-footer>"
